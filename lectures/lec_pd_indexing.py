...
x  = ser.loc['2020-01-03':'2020-01-10']  #include 最后一个数
print(x)
...
#df.loc[row indexer, col indexer]
...
x  = df.loc[['2020-01-02','2020-01-10'],'Close']
print(x)
...
x  = df.loc['2020-01-02':'2020-01-10',:]
x  = df.loc[:,:]
print(x)
print(type(x))
...
a=df.sort_index(inplace=False)
#df.sort_index(inplace=True)
print(a)
b=df.loc['b':'e','col1']
print(type(b))

x = df.loc['b':'e', 'col1':'col1']
#x = df.loc['b':'e', ['col1']]
print(x)
print(type(x))
...
# df.iloc[row indexer, col indexer]
...
x=df.iloc[::2,1]
x=df.iloc[list(range(0,len(df),2)),1]
